...
var I18N = (function () {
    var D = {
        ar: {
            // ===== meta =====
            hub_title: 'استوديو المناسبات | منصة الدعوات الرقمية الفاخرة',
            m_title: 'استوديو المناسبات | أنشئ دعوتك الرقمية الفاخرة',
            ...
            wa_hello: 'مرحباً، أحتاج مساعدة في استوديو المناسبات',
            ...
            m_free_l5: 'شعار استوديو المناسبات',
            m_pop: 'الأكثر شيوعاً',
            ...
            m_tk: 'رسائل محبة',
            m_tt: 'قالوا عنا',
            m_ts: 'عشرات العرسان والمنظمين اختاروا استوديو المناسبات ليتألقوا.',
            ...
            m_fcopy: '© 2026 Occasion Studio. جميع الحقوق محفوظة.',
            ...
            pub_ok: '✅ تم استلام دعوتك بنجاح!',
            pub_copy: 'نسخ', pub_copied: '✅ تم',
            pub_note: 'راجعنا تفاصيلك، وسيصلك رابط دعوتك الخاص على رقم هاتفك/واتساب بعد تأكيد الدفع.',
            pub_err: 'تعذر النشر',
...
pv_now_btn: 'نعم، نحن في الطريق',
        ...
        en: {
            hub_title: 'Occasion Studio | Luxury Digital Invitations Platform',
            m_title: 'Occasion Studio | Create your luxury digital invitation',
            ...
            wa_hello: 'Hello, I need help with Occasion Studio',
            ...
            m_free_l5: 'Occasion Studio logo',
            m_pop: 'Most popular',
            ...
            m_ts: 'Dozens of couples and organizers chose Occasion Studio to shine.',
            ...
            m_fcopy: '© 2026 Occasion Studio. All rights reserved.',
            ...
            pub_ok: '✅ Your invitation details were received!',
            pub_copy: 'Copy', pub_copied: '✅ Copied',
            pub_note: 'We\u2019re reviewing your details — your private invitation link will be sent to your phone/WhatsApp once payment is confirmed.',
